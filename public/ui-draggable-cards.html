...
<head>
	...
	<title>Draggable Cards - Zeiss Template</title>
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="ui-draggable-cards.html">Draggable Cards</a></li>
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h1 class="page-title">Draggable Cards</h1>
		<!-- /.page-title -->
	</div>
	<!-- /.pull-left -->
...
<div id="wrapper">
	<div class="main-content">
		<div class="box-content">
			...
			<!-- /.box-title -->
			Add class <code>.js__sortable</code> into wrapper elements to make all card insides daggable
		</div>
		<!-- .box-content -->
		<div class="row row-inline-block small-spacing js__sortable">
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Card Title</h4>
					<!-- /.box-title -->
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title"><i class="ico fa fa-user"></i>Card Title With Icon</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title text-primary">Card Title With Color</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="box-content bordered primary">
					<h4 class="box-title"><i class="ico glyphicon glyphicon-home"></i>Card Title</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="box-content bordered-all danger">
					<h4 class="box-title"><i class="ico fa fa-warning"></i>Card Title</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="box-content card">
					<h4 class="box-title bg-warning"><i class="ico fa fa-space-shuttle"></i>Card Title</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="box-content card bordered-all success">
					<h4 class="box-title bg-success"><i class="ico fa fa-heartbeat"></i>Card Title</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
		...
		<!-- /.row row-inline-block small-spacing js__sortable -->		
		<footer class="footer">
