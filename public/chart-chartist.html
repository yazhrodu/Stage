...
<head>
	...
	<title>Chartist - Zeiss Template</title>
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="chart-chartist.html">Chartist Charts</a></li>
		...
		<div class="row small-spacing">
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					<h4 class="box-title">Advanced Smil Animations</h4>
					<!-- /.box-title -->
					...
					<div id="smil-animation-chartist-chart" class="chartist-chart" style="height: 320px"></div>
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					<h4 class="box-title">Svg Path Animations</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="line-chartist-chart" class="chartist-chart" style="height: 320px"></div>
					<!-- /#line-chartist-chart.chartist-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					<h4 class="box-title">Line Scatter Diagram</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="scatter-chartist-chart" class="chartist-chart" style="height: 320px"></div>
					<!-- /#scatter-chartist-chart.chartist-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					<h4 class="box-title">Line Chart with Area</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /#area-chartist-chart.chartist-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					<h4 class="box-title">Bi-Polar Line Chart with Area Only</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /#bi-polar-area-chartist-chart.chartist-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="bar-chartist-chart" class="chartist-chart" style="height: 320px"></div>
					<!-- /#bar-chartist-chart.chartist-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					<h4 class="box-title">Horizontal Bar Chart</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="horizontal-bar-chartist-chart" class="chartist-chart" style="height: 320px"></div>
					<!-- /#horizontal-bar-chartist-chart.chartist-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					<h4 class="box-title">Bi-polar Bar Chart</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="bi-polar-bar-chartist-chart" class="chartist-chart" style="height: 320px"></div>
					<!-- /#bi-polar-bar-chartist-chart.chartist-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="stacked-bar-chartist-chart" class="chartist-chart" style="height: 320px"></div>
					<!-- /#stacked-bar-chartist-chart.chartist-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="pie-bar-chartist-chart" class="chartist-chart-pie" style="height: 320px"></div>
					<!-- /#pie-bar-chartist-chart.chartist-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="donut-bar-chartist-chart" class="chartist-chart-pie" style="height: 320px"></div>
					<!-- /#donut-bar-chartist-chart.chartist-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
