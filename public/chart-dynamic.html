...
<head>
	...
	<title>Dynamic Chart - Zeiss Template</title>
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="chart-dynamic.html">Dynamic Chart</a></li>
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h1 class="page-title">Dynamic Chart</h1>
		<!-- /.page-title -->
	</div>
	<!-- /.pull-left -->
		...
		<div class="row small-spacing">
			<div class="col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Random Data Chart</h4>
					<!-- /.box-title -->
			...
			<div class="col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Click to add a point</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
