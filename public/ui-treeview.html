...
<head>
	...
	<title>Treeview - Zeiss Template</title>
	...
	<!-- Boostrap Tree View -->
	<link rel="stylesheet" href="assets/plugin/treeview/bootstrap-treeview.min.css">
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="ui-treeview.html">Tree view</a></li>
...
<div id="wrapper">
	<div class="main-content">
		<div class="row row-inline-block small-spacing">
			...
			<div class="col-md-3 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Collapsed</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-md-3 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Expanded</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-md-3 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Link enabled, or</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-md-4 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Blue Theme</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-md-4 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Custom Icons</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-md-4 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Tags as Badges</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Searchable Tree</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div class="checkbox">
								...
								<label for="chk-ignore-case">
									Ignore Case
								</label>
							</div>
							<div class="checkbox">
								<input type="checkbox" class="checkbox" id="chk-exact-match" value="false">
								<label for="chk-exact-match">
									Exact Match
								</label>
							</div>
							<div class="checkbox">
							...
							<button type="button" class="btn btn-success waves-effect waves-light" id="btn-search">Search</button>
							<button type="button" class="btn btn-default waves-effect waves-light" id="btn-clear-search">Clear</button>
							<!-- </form> -->
						</div>
						<div class="col-md-4">
							<h4>Tree</h4>
