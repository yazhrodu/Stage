...
<head>
	...
	<title>Timeline - Zeiss Template</title>
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="extras-timeline.html">Timeline</a></li>
		...
		<section id="cd-timeline" class="cd-container">
			...
			<div class="cd-timeline-block">
				<div class="cd-timeline-img cd-movie">
					<img src="assets/plugin/timeline/img/cd-icon-movie.svg" alt="Movie">
				</div> 
				<!-- cd-timeline-img -->
			...
			<div class="cd-timeline-block">
				<div class="cd-timeline-img cd-location">
					<img src="assets/plugin/timeline/img/cd-icon-location.svg" alt="Location">
				</div> 
				<!-- cd-timeline-img -->
