...
<head>
	...
	<title>Read Mail - Zeiss Template</title>
						...
						<ul class="mailbox-attachments clearfix">
							<li>
								...
								<div class="mailbox-attachment-info">
									...
									1,245 KB
									<a href="#" class="btn btn-default btn-xs waves-effect waves-light pull-right"><i class="fa fa-cloud-download"></i></a>
									</span>
								</div>
							</li>
							<li>
							...
							<li>
								<span class="mailbox-attachment-icon has-img"><img src="http://placehold.it/1250x835" alt="Attachment"></span>
								<div class="mailbox-attachment-info">
							...
							<li>
								<span class="mailbox-attachment-icon has-img"><img src="http://placehold.it/1254x836" alt="Attachment"></span>
								<div class="mailbox-attachment-info">
