...
<head>
	...
	<title>Jquery Knob - Zeiss Template</title>
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="chart-knob.html">Knob Chart</a></li>
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h1 class="page-title">Jquery Knob</h1>
		<!-- /.page-title -->
	</div>
	<!-- /.pull-left -->
		...
		<div class="row small-spacing">
			<div class="col-lg-3 col-xs-12">
				<div class="box-content">
					...
					<div class="text-center">
						<div class="knob-wrap">
							<input class="knob" data-width="150" data-height="150" data-bgColor="#ebeff2" data-fgColor="#00aeff" data-displayInput=false value="35" />
						</div>
						<!-- .knob-wrap -->
					</div>
				</div>
			...
			<div class="col-lg-3 col-xs-12">
				<div class="box-content">
					...
					<div class="text-center">
						<div class="knob-wrap">
							<input class="knob" data-width="150" data-height="150" data-bgColor="#ebeff2" data-fgColor="#222222" data-thickness=.3 data-cursor=true value="29" />
						</div>
						<!-- .knob-wrap -->
					</div>
				</div>
			...
			<div class="col-lg-3 col-xs-12">
				<div class="box-content">
					...
					<div class="text-center">
						<div class="knob-wrap">
							<input class="knob" data-width="150" data-height="150" data-bgColor="#ebeff2" data-fgColor="#ffa000" data-displayPrevious=true data-min="-100" value="-44" />
						</div>
						<!-- .knob-wrap -->
					</div>
				</div>
			...
			<div class="col-lg-3 col-xs-12">
				<div class="box-content">
					...
					<div class="text-center">
						<div class="knob-wrap">
							<input class="knob" data-width="150" data-height="150" data-bgColor="#ebeff2" data-fgColor="#f60e0e" data-angleOffset=90 data-linecap=round value="75" />
						</div>
						<!-- .knob-wrap -->
					</div>
				</div>
			...
			<div class="col-lg-3 col-xs-12">
				<div class="box-content">
					...
					<div class="text-center">
						<div class="knob-wrap">
							<input class="knob" data-width="150" data-height="150" data-bgColor="#ebeff2" data-fgColor="#00bf4f" data-angleOffset=-125 data-angleArc=250 data-rotation=anticlockwise value="35" />
						</div>
						<!-- .knob-wrap -->
					</div>
				</div>
			...
			<div class="col-lg-3 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">4-digit, step 1</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<div class="text-center">
						<div class="knob-wrap">
							<input class="knob" data-width="150" data-height="150" data-bgColor="#ebeff2" data-fgColor="#5b69bc" data-step="1" value="0" data-min="-10000" data-max="10000" data-displayPrevious=true />
						</div>
						<!-- .knob-wrap -->
					</div>
				</div>
			...
			<div class="col-lg-3 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Infinite wheel</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<div class="text-center">
						<div class="knob-wrap">
							<input class="knob" data-width="150" data-height="150" data-cursor=true data-thickness=".5" data-fgColor="#ff460b" data-bgColor="#ebeff2" data-displayInput="false" value="20" />
						</div>
						<!-- .knob-wrap -->
					</div>
				</div>
			...
			<div class="col-xs-12">
				<div class="box-content bg-inverse">
					<h4 class="box-title text-white">Overloaded 'draw' method</h4>
					<!-- /.box-title -->
					<div class="text-center">
						<div class="row">
