...
<head>
	...
	<title>Flot Chart - Zeiss Template</title>
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="chart-flot.html">Flot Chart</a></li>
		...
		<div class="row small-spacing">
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					<h4 class="box-title">Response Time (ms)</h4>
					<!-- /.box-title -->
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="pile-flot-chart" class="flot-chart" style="height: 320px"></div>
					<!-- /#flot-chart-1.flot-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="donut-flot-chart" class="flot-chart" style="height: 320px"></div>
					<!-- /#flot-chart-1.flot-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			...
			<div class="col-md-12">
				<div class="box-content">
					<h4 class="box-title">Multiple Lines Chart</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="lines-flot-chart" class="flot-chart" style="height: 320px"></div>
					<!-- /#flot-chart-1.flot-chart -->
				</div>
				<!-- /.box-content -->
			</div>
