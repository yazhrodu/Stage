...
<head>
	...
	<title>Wysiwig Editor - Zeiss Template</title>
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="form-wysiwig.html">Wysiwig Editors</a></li>
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h1 class="page-title">Wysiwig Editor</h1>
		<!-- /.page-title -->
	</div>
	<!-- /.pull-left -->
