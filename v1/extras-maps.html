...
<head>
	...
	<title>Maps - Zeiss Template</title>
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="extras-maps.html">Maps</a></li>
...
<div id="wrapper">
		...
		<div class="row small-spacing">
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					...
					<div id="map-default" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="map-marker" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
			...
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Polyline</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="map-poly" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
			...
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="map-polygon" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
			...
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="map-circle" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
			...
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Info window</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="map-info" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
			...
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="map-hybrid" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
			...
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">45° Perspective View</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="map-45" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Light Dream Themes</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="map-light-dream" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
			...
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Blue Essence Themes</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="map-blue-essence" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
			...
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Midnight Commander Themes</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="map-midnight-commander" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
			...
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Flat Themes</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<div id="map-flat" style="width: 100%; height: 320px"></div>
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-xs-12 -->
	...
	<script src="assets/scripts/map.demo.js"></script>
