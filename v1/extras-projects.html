...
<head>
	...
	<title>Projects - Zeiss Template</title>
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="extras-projects.html">Projects</a></li>
		...
		<div class="prj-list row">
				...
				<a href="#" class="prj-item">
					<div class="top-project-section">
						<div class="project-icon">
							<img src="http://placehold.it/184x170" alt="">
						</div>
						<h3>Bold Meida</h3>
						<div class="meta">
							<p class="author">
			...
			<div class="col-lg-4 col-md-6 col-xs-12 margin-bottom-30">
				<a href="#" class="prj-item">
					<div class="top-project-section">
						<div class="project-icon">
							<img src="http://placehold.it/182x197" alt="">
						</div>
						<h3>Helperia</h3>
						<div class="meta">
							<p class="author">
			...
			<div class="col-lg-4 col-md-6 col-xs-12 margin-bottom-30">
				<a href="#" class="prj-item">
					<div class="top-project-section">
						<div class="project-icon">
							<img src="http://placehold.it/233x233" alt="">
						</div>
						<h3>Tutum</h3>
						<div class="meta">
							<p class="author">
