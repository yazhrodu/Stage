...
<head>
	...
	<title>Chart.js - Zeiss Template</title>
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="chart-chartjs.html">Chartjs Chart</a></li>
		...
		<div class="row small-spacing">
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<canvas id="horizontal-bar-chartjs-chart" class="chartjs-chart" width="480" height="320"></canvas>
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<canvas id="line-chartjs-chart" class="chartjs-chart" width="480" height="320"></canvas>
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<canvas id="area-chartjs-chart" class="chartjs-chart" width="480" height="320"></canvas>
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<canvas id="donut-chartjs-chart" class="chartjs-chart" width="480" height="320"></canvas>
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					<h4 class="box-title">Polar Chart</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<!-- /.dropdown js__dropdown -->
					<canvas id="polar-chartjs-chart" class="chartjs-chart" width="480" height="320"></canvas>
					<!-- /#polar-chartjs-chart.chartjs-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
			...
			<div class="col-lg-6 col-md-12">
				<div class="box-content">
					...
					<!-- /.dropdown js__dropdown -->
					<canvas id="radar-chartjs-chart" class="chartjs-chart" width="480" height="320"></canvas>
					<!-- /#radar-chartjs-chart.chartjs-chart -->
				</div>
				<!-- /.box-content -->
			</div>
			<!-- /.col-lg-6 col-md-12 -->
