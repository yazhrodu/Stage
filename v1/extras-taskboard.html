...
<head>
	...
	<title>Taskboard - Zeiss Template</title>
			...
			<ul class="menu js__accordion">
				...
				<li class="current active">
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="extras-taskboard.html">Taskboard</a></li>
		...
		<div class="row small-spacing">
			<div class="col-lg-4 col-xs-12">
				<div class="box-content">
					<h4 class="box-title text-info">Upcoming</h4>
					<!-- /.box-title -->
			...
			<div class="col-lg-4 col-xs-12">
				<div class="box-content">
					<h4 class="box-title text-warning">To do</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-lg-4 col-xs-12">
				<div class="box-content">
					...
					<div class="task-lists">
						...
						<a href="#" class="task-item">
							<img src="http://placehold.it/1000x667" alt="" class="margin-bottom-10">
							<div class="title">Cum voluptate quo cumque assumenda debitis.</div>
							<!-- /.title -->
							<div class="metas">
								<div class="meta"><i class="fa fa-comment-o ico"></i>14</div>
